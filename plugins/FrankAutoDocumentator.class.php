...
/**
 * Please note that FrankAutoDocumentation is instantiated twice
 * once as a middleware, another time: as callback
 */
class FrankAutoDocumentator extends Frank_Middleware {
  private $path = '/docs';
  ...
  function preprocess(&$router) {
    $router->addRoute(array(
      'path' => $this->path,
      'get'  => array('FrankAutoDocumentator', 'generateDocs'),
    ));
  }
